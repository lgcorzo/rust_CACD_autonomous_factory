...
async def main() -> None:
    ...
    try:
        ...
        print(
            f"✅ Coder Result: {coder_result.keys() if isinstance(coder_result, dict) else coder_result}"
        )
    except Exception as e:
    ...
    try:
        ...
        print(
            f"✅ Tester Result: {tester_result.keys() if isinstance(tester_result, dict) else tester_result}"
        )
    except Exception as e:
    ...
    try:
        ...
        print(
            f"✅ Reviewer Result: Approved={review_result.approved}, Comments={review_result.comments}"
        )
    except Exception as e:
