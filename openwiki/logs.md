...
| Field Name | Value |
| :--- | :--- |
| **Generation Mode** | Full Documentation Mode (`full`) |
| **Target Repository** | `rust_CACD_autonomous_factory` |
| **Commit SHA** | `main` (`HEAD`) |
| **Timestamp** | `2026-07-31T16:35:00Z` |
| **Primary Skill** | `uml2-okf-documenter` |
| **ISO Standards** | ISO 42010, ISO 15289, ISO 25010, ISO 26514 |
| **AST Nodes Extracted** | `1453` nodes |
| **AST Edges Extracted** | `2006` edges |
...
```
[2026-07-31T16:35:00Z] SUCCESS: Initial ISO-compliant OpenWiki DeepWiki generated across all 5 workspace crates:
  - openwiki/index.md
  ...
  - openwiki/modules/factory_core/executor.md
  - openwiki/modules/factory_core/security.md
  - openwiki/modules/factory_core/error.md
  - openwiki/modules/factory_infrastructure/aethalgard.md
