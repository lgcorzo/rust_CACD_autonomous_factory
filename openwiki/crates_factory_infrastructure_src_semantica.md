...
**Overview:**
Why it exists:
Provides capabilities related to Conflict.
...
**Overview:**
Why it exists:
Provides capabilities related to DecisionRecord.
...
**Overview:**
Why it exists:
Provides capabilities related to HttpSemanticaClient.
...
**Overview:**
Why it exists:
Provides capabilities related to MissionPlan.
...
**Overview:**
Why it exists:
Provides capabilities related to ProvenanceReport.
...
**Overview:**
Why it exists:
Provides capabilities related to SemanticaClient.
...
SemanticaClient <|-- HttpSemanticaClient : Inheritance / Specialization
class MissionPlan {
}
...
participant Svc as "SemanticaService"
Caller -> Svc : execute()
