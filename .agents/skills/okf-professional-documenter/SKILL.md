...
3. Recommended Directory Setup in Workspace
Path
Type
Purpose
...
Configuration
Houses the master skill instructions for your IDE or coding agent.
openwiki/
Output Directory
Mirrors the source layout 1:1, storing Markdown files with OKF frontmatter.
openwiki/index.md
Index
Serves as the root navigation hub for LLMs and human reviewers.
