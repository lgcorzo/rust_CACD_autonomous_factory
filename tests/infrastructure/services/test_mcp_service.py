...
def test_mcp_service_start(mcp_service: MCPService) -> None:
...
def test_mcp_service_load_prompts_not_found() -> None:
...
def test_mcp_service_get_prompt_lazy_load(mcp_service: MCPService) -> None:
    """Test get_prompt triggers lazy loading."""
    with patch(
        "autogen_team.infrastructure.services.mcp_service.MCPService._load_prompts"
    ) as mock_load:
...
def test_mcp_service_stop(mcp_service: MCPService) -> None:
...
def test_mcp_service_r2r_client_property(mcp_service: MCPService) -> None:
...
def test_mcp_service_r2r_client_failure() -> None:
