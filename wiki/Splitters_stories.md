...
- **Infrastructure Layer (Splitters)**: [src/autogen_team/infrastructure/utils/splitters.py](../src/autogen_team/infrastructure/utils/splitters.py)

## Test location

- [tests/infrastructure/utils/test_splitters.py](../tests/infrastructure/utils/test_splitters.py)
